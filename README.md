...
*   **Quick Access:** Click the extension icon or use `Ctrl+Z` (configurable) to open all your selected default websites simultaneously in new tabs.
...
4.  Use the checkboxes to select which websites should open when you click the extension icon or use the main shortcut (`Ctrl+Z`).
...
*   **Main Action (Open selected sites):** `Ctrl+Z` (Default, configurable in `chrome://extensions/shortcuts`)
